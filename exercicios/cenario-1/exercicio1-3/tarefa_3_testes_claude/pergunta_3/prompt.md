...
--- Chunk 1 | Arquivo: SLA-2024-tabela-sla-clientes.md | Seção: 5. Medição e reportes ---
...
--- Chunk 2 | Arquivo: FAQ-atendimento.md | Seção: Item 41 — "Qual a diferença entre SLA de resposta e SLA de resolução?" ---
...
--- Chunk 3 | Arquivo: FAQ-atendimento.md | Seção: Item 15 — "Cliente diz que é Platinum. Existe esse tier?" ---
