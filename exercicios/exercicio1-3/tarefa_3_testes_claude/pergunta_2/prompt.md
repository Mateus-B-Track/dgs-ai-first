...
--- Chunk 1 | Arquivo: FAQ-atendimento.md | Seção: Item 22 — "Cliente quer saber sobre seguro de carga. O que falar?" ---
...
--- Chunk 2 | Arquivo: PROC-042-frete-especial-v1.md | Seção: 4. Condições especiais ---
...
--- Chunk 3 | Arquivo: POL-001-politica-devolucao.md | Seção: 3.2. Exceções ao prazo geral ---
...
Cargas perigosas podem ser devolvidas?